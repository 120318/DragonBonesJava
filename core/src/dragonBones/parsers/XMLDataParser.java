...
public class XMLDataParser {
    ...
    public DragonBonesData parseDragonBonesData(FileHandle dragonBonesFile, float scale) {

        try {
            element = reader.parse(dragonBonesFile.file());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public DBTextureAtlasData parseTextureAtlasData(FileHandle textureAtlasFile, float scale) {
        try {
            element = reader.parse(textureAtlasFile.file());
        } catch (IOException e) {
            e.printStackTrace();
        }
        textureScale = scale;
        ...
        textureAtlasData.textureFile = textureAtlasFile.parent().child(imagePath);
